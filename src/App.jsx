...
@keyframes tickerMove {
  ...
  .nav-logo:hover { color: var(--green-mid); transform: scale(1.03); }
    ...
    <div className="ticker">
      ...
      <nav className={scrolled?"scrolled":""}>
        ...
        <div className="nav-right">
          <button className="nav-icon-btn" onClick={()=>navigate("products")}>⌕</button>
          ...
          <button className="btn-cart" onClick={()=>navigate("cart")}>Cart (2)</button>
        </div>
      </nav>
        ...
        <>
          ...
          <section className="hero">
            ...
            <div className="hero-content">
              ...
              <h1 className="hero-title">Shift<span>Happens.</span></h1>
